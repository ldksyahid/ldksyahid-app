...
//                     //         <a href="javascript:void(0)" class="btn btn-sm btn-primary m-1" onClick="edit( $data->id )"><i class="fa fa-edit"></i></a><br>
//                     //         <button class="btn btn-sm btn-primary m-1" onClick="destroyuser({{ $item->id }})"><i class="fa fa-trash"></i></button><br>
