            ...
            'actions' => [
                ...
                'custom' => [
                    ...
                    [
                        ...
                        'ownerField'        => 'createdBy',
                        'ownerCompareField' => 'name',
                        'routeName'         => 'admin.forms.responses.delete',
                        'method'            => 'DELETE',
                        'confirm'           => [
                            'title'             => 'Delete all responses?',
                            'text'              => 'This will permanently delete all submissions and uploaded files. Google Sheets data will also be cleared. This cannot be undone.',
                            'confirmButtonText' => 'Yes, Delete All',
                            'confirmButtonColor'=> '#dc3545',
                        ],
                        'successMsg'        => 'All responses deleted successfully.',
                    ],
                ],
            ],
        ];
