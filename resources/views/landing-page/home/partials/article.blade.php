        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item bg-light overflow-hidden h-100 shadow">
                    <a href="/articles/{{ $postarticle->id }}"><img class="img-fluid" src="https://drive.google.com/thumbnail?id={{ $postarticle->gdrive_id }}" alt="{{$postarticle->title}}" /></a>
    ...
    <div class="container">
        <div class="row g-5 align-items-end mb-5 wow fadeInUp" data-wow-delay="0.5s">
            ...
            <div class="mt-2">
                ...
                <div class="item">
                    <div class="my-3">
                        <a href="/articles/{{ $postarticle->id }}" class="d-flex justify-content-center"><img class="shadow" src="https://drive.google.com/thumbnail?id={{ $postarticle->gdrive_id }}" alt="{{$postarticle->title}}" style="width: 100%; border-radius: 2%;" /></a>
                    </div>
                </div>
                @empty
