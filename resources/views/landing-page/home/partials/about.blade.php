...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <h1 class="display-6">UKM LDK Syahid UIN Syarif Hidayatullah Jakarta</h1>
        </div>

        <!-- Sejarah -->
        <div class="row align-items-start mb-5 g-4 wow fadeInUp" data-wow-delay="0.3s">
            <div class="col-lg-7">
                <h4 class="mb-3 text-primary">Sejarah</h4>
            ...
            <div class="col-lg-5 text-center">
                <img src="https://lh3.googleusercontent.com/d/1a0T3LKmzN9mow39mWYwFPGqTpmSXjNk1" alt="Gambar LDK Syahid" class="img-fluid wow fadeInUp" data-wow-delay="0.5s">
                <p class="mt-4 fst-italic text-muted">LDK Syahid adalah UKM keislaman yang aktif dalam mentoring, kajian, rihlah, softskill, ukhuwah, dan pembentukan karakter kepemimpinan.</p>
            </div>
        </div>

        <!-- Visi dan Misi -->
        <div class="row g-4 wow fadeInUp" data-wow-delay="0.4s">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <h4 class="mb-3 text-primary">Misi</h4>
