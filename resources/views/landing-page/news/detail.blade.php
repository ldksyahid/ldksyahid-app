...
<meta property="og:image" content="https://lh3.google.com/u/0/d/{{ $postnews->gdrive_id }}" />
        ...
        <div class="row g-5">
            ...
            <div class="wow fadeInUp " data-wow-delay="1.0s">
                <div class="col-lg-10 col-md-6 text-start">
                    ...
                    <img src="https://lh3.google.com/u/0/d/{{ $postnews->gdrive_id }}" alt="{{$postnews->title}}" class="img-fluid rounded">
