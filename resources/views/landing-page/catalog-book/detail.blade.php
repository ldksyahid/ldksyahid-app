        ...
        <div class="col-lg-4 col-md-5">
            ...
            <div class="book-cover-elegant wow fadeInUp" data-wow-delay="0.1s">
                <div class="cover-container">
                    ...
                    @else
                        <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300' preserveAspectRatio='xMidYMid meet'%3E%3Crect width='400' height='300' fill='%23e9ecef'/%3E%3Cpolygon points='80,240 200,120 320,240' fill='%23ced4da'/%3E%3Cpolygon points='200,240 300,160 400,240' fill='%23adb5bd'/%3E%3Ccircle cx='310' cy='100' r='35' fill='%23dee2e6'/%3E%3Crect y='240' width='400' height='60' fill='%23dee2e6'/%3E%3Ctext x='200' y='275' text-anchor='middle' fill='%236c757d' font-family='sans-serif' font-size='15'%3ENo Image%3C/text%3E%3C/svg%3E" alt="{{ $book->titleBook }}" class="cover-image">
                    @endif
                ...
                <div class="related-books-grid">
                    ...
                    <div class="related-book-card">
                        ...
                        <div class="book-cover-small">
                            ...
                            @else
                                <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300' preserveAspectRatio='xMidYMid meet'%3E%3Crect width='400' height='300' fill='%23e9ecef'/%3E%3Cpolygon points='80,240 200,120 320,240' fill='%23ced4da'/%3E%3Cpolygon points='200,240 300,160 400,240' fill='%23adb5bd'/%3E%3Ccircle cx='310' cy='100' r='35' fill='%23dee2e6'/%3E%3Crect y='240' width='400' height='60' fill='%23dee2e6'/%3E%3Ctext x='200' y='275' text-anchor='middle' fill='%236c757d' font-family='sans-serif' font-size='15'%3ENo Image%3C/text%3E%3C/svg%3E" alt="{{ $relatedBook->titleBook }}">
                            @endif
                        </div>
