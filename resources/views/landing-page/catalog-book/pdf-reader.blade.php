    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="flipbook-container wow fadeIn" data-wow-delay="0.2s">
                ...
                <div id="flipbook-container" class="flipbook-wrapper">
                    <div id="flipbook" class="custom-flipbook">
                        <!-- Pages will be generated by JavaScript -->
                    </div>

                    <!-- Navigation Arrows -->
                    <div class="flipbook-nav">
                        <button class="nav-btn prev-btn" onclick="flipToPrevPage()">
                            <i class="fas fa-chevron-left"></i>
                        </button>
                        <button class="nav-btn next-btn" onclick="flipToNextPage()">
            ...
            <div class="reader-controls">
                <div class="controls-container">
                    ...
                    <div class="control-group">
                        <button class="btn-control" onclick="flipToPrevPage()" title="Halaman Sebelumnya">
                            <i class="fas fa-chevron-left"></i>
                        </button>
                        <span class="page-info">
                            Halaman <span id="current-page">0</span> dari <span id="total-pages">0</span>
                        </span>
                        <button class="btn-control" onclick="flipToNextPage()" title="Halaman Berikutnya">
                            <i class="fas fa-chevron-right"></i>
                        </button>
                    </div>
                    ...
                    <!-- View Mode -->
                    <div class="control-group">
                        <button class="btn-control" id="single-page-btn" onclick="setViewMode('single')" title="Satu Halaman">
                            <i class="fas fa-file"></i>
                        </button>
                        <button class="btn-control" id="double-page-btn" onclick="setViewMode('double')" title="Dua Halaman">
