            ...
            <div class="col-lg-8 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="border-start border-end border-bottom border-top border-5 border-primary mb-5 p-5">
                    ...
                    <div class="col-sm-6 d-flex wow fadeIn mt-5" data-wow-delay="0.3s">
                        ...
                        <div class="row">
                            <h6 class="mb-0"><a href="https://api.whatsapp.com/send?phone=+6282115219350&text=*%5BFOLLOW%20UP%20LAYANAN%20PERPENDEK%20URL%5D*%0A%0A_Assalammu%27alaikum_%0A%0AIzin%20untuk%20*Memfollow%20up%20Layanan%20Perpendek%20URL*%20dan%20saya%20telah%20mengisi%20formulir%20tersebut%0A%0A_Terimakasih%20Sebelumnya_%0A_Wassalammua%27laikum_%0A%0A%23KitaAdalahSaudara%0A%23LDKSyahid%0A%23UINJakarta" target="_blank">{{strtoupper('Nisrina Hasya Nazihah')}}</a></h6><br>
                            <p class="mb-0">+62 - 821 - 1521 - 9350</p>
                        </div>
                    </div>
                    <p class="mb-0 mt-5">
