...
<svg xmlns="http://www.w3.org/2000/svg" width="{{ $width }}" height="{{ $height }}" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice" class="svg-placeholder" style="width: 100%; max-width: 100%; height: auto; display: block; border-radius: 12px; border: 1px solid #ced4da;">
