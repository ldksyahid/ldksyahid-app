{{-- <table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align='center'>
                @if ($item->default_short_url == null)
                    <p class="small">Nothing</p>
                @else
                    <a href="{{ $item->default_short_url }}" target="_blank">{{ substr($item->default_short_url, 0, 10) }}</a>
                @endif
            </td>
            <td align="center">
