...
<div class="container-xxl py-5">
    <div class="container">
        <div class="row g-5">
            <div class="col-3">
                <img src="{{ asset($postevent->poster) }}" alt="{{ $postevent->title }}" style="border-radius: 5px;" class="img-fluid shadow">
            </div>
            <div class="col-6">
                            ...
                            <div class="col-3">
                                <div class="mb-5">
                                    ...
                                    <div class="alert alert-info" role="alert" style="border-radius: 5px;">
                                        <p class="mb-0">Maaf, Event sedang berlangsung</p>
                                    </div>
                                    @else
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <p>{{ $postevent->location }} <br><a href="{{ $postevent->linkLocation }}" target="_blank">{{ $postevent->linkLocation }}</a></p>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-desc" role="tabpanel" aria-labelledby="pills-desc-tab">
                    <div class="mb-5">
                        ...
                        <a class="btn btn-primary shadow w-100 mt-0" href="/events" style="border-radius: 5px; font-size: 14px;">Daftar</a>
                        @elseif (time() > strtotime($postevent->start) && time() <= strtotime($postevent->finished))
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <p style="font-size: 16px;">{{ $postevent->location }} <br><a href="{{ $postevent->linkLocation }}" target="_blank">{{ $postevent->linkLocation }}</a></p>
                                <h1 class="display-6" style="font-size: 14px">{{ $postevent->place }}</h1>
                            </div>
                            @else
                            <div class="col-12">
...
<script>
    ...
    */
    ...
    s.src = 'https://https-ldksyah-id.disqus.com/embed.js';
...
<script id="dsq-count-scr" src="//https-ldksyah-id.disqus.com/count.js" async></script>
