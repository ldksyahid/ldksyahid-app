    ...
    <div class="row g-4">
        <div class="col-sm-6 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                <h5 class="mb-4">Create Schedule LDK Syahid</h5>
                ...
                @method('POST')
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputTitleSchedule" name='title' placeholder="Enter the Schedule Title..." required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputMonth" name='month' placeholder="Fill Must like Ex. September" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputYear" name='year' placeholder="Fill Must like Ex. 2022" required>
                        <div class="invalid-feedback">
