                                ...
                                @if ($operation === 'view')
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            ...
                                            <small class="text-muted">({{ \Carbon\Carbon::parse($structure->created_at)->format('H:i T') }})</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            ...
                                            <small class="text-muted">({{ \Carbon\Carbon::parse($structure->updated_at)->format('H:i T') }})</small>
                                        </div>
                                    </div>
                                @endif
                            </div>
