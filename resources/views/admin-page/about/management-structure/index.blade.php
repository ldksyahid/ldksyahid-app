                        ...
                        <table class="table table-hover table-striped text-nowrap small" id="dataStructure">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align='center'>
                                        <img style="width: 100px;" src="https://lh3.google.com/u/0/d/{{ $data->gdrive_id }}" alt="{{$data->structureName}}" class="card-img"/>
                                    </td>
                                    <td align='center'>
                                        <img style="width: 100px;" src="https://lh3.google.com/u/0/d/{{ $data->gdrive_id_2 }}" alt="{{$data->structureName}}" class="card-img"/>
                                    </td>
                                    <td align="center">
