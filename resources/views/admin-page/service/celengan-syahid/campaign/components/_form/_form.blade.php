                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            ...
                                            <small class="text-muted">({{ \Carbon\Carbon::parse($data->created_at)->format('H:i T') }})</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            ...
                                            <small class="text-muted">({{ \Carbon\Carbon::parse($data->updated_at)->format('H:i T') }})</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
