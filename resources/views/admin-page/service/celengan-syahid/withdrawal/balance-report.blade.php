                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th class="ps-4">#</th>
                                    <th>Campaign</th>
                                    <th class="text-end">QRIS PAID (Gross)</th>
                                    <th class="text-end">After MDR (1%)</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end text-muted">Rp {{ number_format($row['total_qris'], 0, ',', '.') }}</td>
                                    <td class="text-end">Rp {{ number_format($row['wallet_credit'], 0, ',', '.') }}</td>
