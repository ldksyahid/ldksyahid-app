            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    @php
                        ...
                        // Gap-based: calculate expected using ALL paid donations minus all sent withdrawals.
                    ...
                    <div class="cs-pending-note">
                        ...
                        <span><strong>Rp {{ number_format($pendingIdx, 0, ',', '.') }}</strong>
                        from recent QRIS payment(s) is settling in Bisatopup wallet (~5 min) — excluded from balance comparison above.</span>
                    </div>
                    @endif
                    @else
