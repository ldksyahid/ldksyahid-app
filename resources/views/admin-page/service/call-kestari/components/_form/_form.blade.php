                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            ...
                                            <small class="text-muted ms-1">({{ \Carbon\Carbon::parse($callKestari->created_at)->format('H:i T') }})</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            ...
                                            <small class="text-muted ms-1">({{ \Carbon\Carbon::parse($callKestari->updated_at)->format('H:i T') }})</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
