                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="row">
                            <!-- Report Information -->
                            <div class="col-md-6">
                                <h5 class="section-title mb-3"><i class="fas fa-info-circle me-2"></i>Report Details</h5>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">LDK Tag</label>
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="d-flex justify-content-center gap-2 mb-3">
                                                ...
                                                <a href="{{ $financeReport->fileViewUrl() }}" target="_blank" class="btn btn-outline-primary">
                                                    <i class="fa fa-eye me-1"></i> View in Google Drive
                                                </a>
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="form-text mt-2">Note: Some browsers may require download to view PDF</div>
                                            </div>
                                        </div>
                                    </div>
                                @else
