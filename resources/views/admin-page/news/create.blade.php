    ...
    <div class="row g-4">
        <div class="col-sm-6 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                <h5 class="mb-4">Create News LDK Syahid</h5>
                ...
                @method('POST')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputPublisher" name='publisher' placeholder="Fill the Publisher Ex. LDK Syahid UIN Jakarta" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputTitle" name='title' placeholder="Fill the Title..." required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputReporter" name='reporter' placeholder="Fill the Name of Reporter..." required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputEditor" name='editor' placeholder="Fill the Name of Editor..." required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3 col-xl-4">
                        ...
                        <input class="form-control" type="file" id="picture" name = 'picture' accept="image/png, image/jpeg, image/jpg, image/JPG, image/PNG, image/webp" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputDescPicture" name='descpicture' placeholder="Fill the Picture Description..." required>
                        <div class="invalid-feedback">
