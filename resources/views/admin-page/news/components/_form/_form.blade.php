                                ...
                                @if ($operation === 'view')
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            ...
                                            <small class="text-muted ms-1">({{ \Carbon\Carbon::parse($news->created_at)->format('H:i T') }})</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            ...
                                            <small class="text-muted ms-1">({{ \Carbon\Carbon::parse($news->updated_at)->format('H:i T') }})</small>
                                        </div>
                                    </div>
                                @endif
                            </div>
